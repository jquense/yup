  ...
  test: (function (_test) {
    ...
    function validate(value, path, context) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (ValidationError.isError(validOrError)) throw normalizeError(validOrError, errorMsg, opts.params, path, value);else if (!validOrError) throw new ValidationError(errorMsg(babelHelpers._extends({ path: path }, opts.params)), path, value);
      });
    }
  }),
