...
SchemaType.prototype = {
  ...
  cast: function(_value, context){
    var schema = this._resolve(context)
    return schema._cast(_value)
  },
  ...
  _cast: function(_value){
    ...
    return _.reduce(self.transforms, function(value, transform){
  ...
  _validate: function(value, _options, _state) {
    var valids   = this._whitelist
      ...
      , context  = (_options || {}).context || _state.parent
      , schema, isType, valid, state, options;
    ...
    if( options.strict !== true )
      value = schema.cast(value, context, false)
    ...
    valid =  _.every(schema.validations, function(fn){
