...
module.exports = {
  ...
  "Array": AbstractField.extend({
    ...
    constructor: function ArrayField(options){
      AbstractField.call(this, options)
      this.field = new fieldTypes[typeName(this.subType)](options)
    },

    cast: function(value){
      return _.map(values, this.field.cast, this.field)
    },
