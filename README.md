...
- [Yup](#yup)
  ...
  - [API](#api)
    ...
    - [string](#string)
      ...
      - [`string.slug(message?: string | function): Schema`](#stringslugmessage-string--function-schema)
    - [number](#number)
...
#### `string.slug(message?: string | function): Schema`

Validates the value as a slug via a regex.
